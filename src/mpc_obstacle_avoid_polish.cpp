...
/**
 * @brief All constant tuned parameters
 * 
 */
...
const double goalWeight = 1.0;
const double obsWeight = 1.0;
const double speedWeight = 0.1;
...
/**
 * @brief CLAMP to Angle
 * 
 * @tparam T 
 * @param value : angle 
 * @return T angle after being clamped +- 2pi
 */
template<typename T>
...
/**
 * @brief MPC problem/Cost functor , set up residual (cost fuction) to minimize with some initializations
 * 
 */
struct MPCProblem {
...
/**
 * @brief Main controller class that will perform obtaning obstacle positions, solve MPC problem 
 * and publish to robot velocities
 * 
 */
...
/**
 * @brief callback of odom to receive current robot positions and velocities
 * 
 * @param msg 
 */
...
/**
 * @brief callback function to receive scan ranges data from Lidar 
 * -> get obstacles' Cartesian coordinates
 * 
 * @param msg 
 */
...
/**
 * @brief main fuction, just for calling the class object, spin and shutdown
 * 
 * @param argc 
 * @param argv 
 * @return int 
